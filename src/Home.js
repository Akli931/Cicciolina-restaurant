...
<div>
  ...
  <div className="home-container">
    <div className="home-content">
      ...
      <p>
        Découvrez une expérience culinaire italienne raffinée au cœur de notre
        restaurant. Savourez des plats authentiques préparés avec amour.
      </p>
      <button
  ...
  <div className="style-container">
    ...
    <div className="style-text-box">
      <h2>Découvrez notre menu appétissant</h2>
      <p>
        Savourez des plats italiens authentiques, préparés avec passion et des
        ingrédients de qualité. Cliquez ci-dessous pour explorer notre carte.
      </p>
      <button
  ...
  <div className="map-container">
    ...
    ></iframe>
      ...
      <footer>
        ...
        <p>Contact : 09 74 64 10 86</p>
        <p>
        <Link to="/mentionsLegales" style={{ color: "#d4af37", textDecoration: "none" }}>Mentions légales</Link>
  </p>
      </footer>
    </div>
  );
